# Prompt: resolve-claim

## Task
Resolve contradictory claims and keep both default outcome and human override visible.

## Goal
Generate deterministic workflow output for resolve-claim.
...
## Done condition
resolve-claim updates are applied deterministically with provenance, privacy, and auditability preserved.
