...
## Task
Crystallize completed work into durable digests and reusable patterns.

## Goal
Generate deterministic workflow output for crystallize.
...
## Done condition
crystallize updates are applied deterministically with provenance, privacy, and auditability preserved.
